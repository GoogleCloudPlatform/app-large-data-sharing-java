...
public class FileServiceTest {
    ...
    public void setUpMockService() throws Exception {
        ...
        Mockito.doNothing().when(storageService).save(any(), any(), any());
        Mockito.doNothing().when(storageService).delete(any());
        Mockito.doNothing().when(storageService).batchDelete();
    }
    ...
    public void testUploadFiles() throws InterruptedException, ExecutionException, IOException {
        ...
        assertThat(files.get(0).isImage()).isTrue();
